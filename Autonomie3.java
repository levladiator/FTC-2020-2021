 ...
 *  LBM \       / RBM
 */
@Autonomous(name="Autonomie 3", group="Exercises")
@Disabled
public class Autonomie3 extends LinearOpMode
{
    ...
    public void move(double distance)
    {
        ...
        leftFrontMotor.setTargetPosition((int) (-distance * COUNTS_PER_CM));
        rightFrontMotor.setTargetPosition((int) (distance * COUNTS_PER_CM));
        rightBackMotor.setTargetPosition((int) (distance * COUNTS_PER_CM));
        ...
        {
            telemetry.addData("lb", leftBackMotor.getCurrentPosition() + "  busy=" + leftBackMotor.isBusy());
            telemetry.addData("lf", leftFrontMotor.getCurrentPosition() + "  busy=" + leftFrontMotor.isBusy());
            telemetry.addData("rb", rightBackMotor.getCurrentPosition() + "  busy=" + rightBackMotor.isBusy());
            telemetry.addData("rf", rightFrontMotor.getCurrentPosition() + "  busy=" + rightFrontMotor.isBusy());
            ...
            if(distance > 0) {
                ...
                leftFrontMotor.setPower(-genPower);
                rightBackMotor.setPower(genPower);
